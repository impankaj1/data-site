        ...
        items: [
          {
            ...
            href: "/data?category=TECHNOLOGY#explorer",
...
export const FOOTER_LINK_GROUPS: FooterLinkGroup[] = [
  ...
  },
  {
    title: "Key Sectors",
    links: [
      { label: "Artificial Intelligence & Cloud", href: "/data?category=TECHNOLOGY#explorer" },
      { label: "Global Finance & Banking", href: "/data?category=FINANCE#explorer" },
      { label: "Healthcare & Pharmaceuticals", href: "/data?category=HEALTHCARE#explorer" },
      { label: "Clean Energy & Smart Grids", href: "/data?category=ENERGY#explorer" },
      { label: "E-Commerce & Omnichannel", href: "/data?category=RETAIL#explorer" },
    ],
  },
  {
    title: "Company",
